...
PresetMetadata buildPresetMetadata(const int bassIndex, const InstrumentPreset& preset)
{
    ...
    if (lowerName.find("lead") != std::string::npos || lowerName.find("solo") != std::string::npos)
        metadata.mixRole = "lead-bass";
    else if (lowerName.find("pad") != std::string::npos
             || lowerName.find("ambient") != std::string::npos
             || lowerName.find("drone") != std::string::npos
             || lowerName.find("cin") != std::string::npos
             || lowerName.find("film score") != std::string::npos
             || lowerName.find("lush") != std::string::npos)
        metadata.mixRole = "texture-bass";
    else if (lowerName.find("slap") != std::string::npos || lowerName.find("punch") != std::string::npos
             || lowerName.find("attack") != std::string::npos || lowerName.find("staccato") != std::string::npos)
        metadata.mixRole = "transient-bass";
    else if (lowerName.find("sub") != std::string::npos || lowerName.find("boom") != std::string::npos
             || lowerName.find("deep") != std::string::npos)
        metadata.mixRole = "sub-foundation";
...
const std::array<std::vector<InstrumentPreset>, kNumBasses>& getFactoryPresetBanks()
{
    ...
    static const auto banks = []()
    {
        ...
        // =====================================================================
        {
            // --- Neutres / fondamentaux ---
            { "Groove Motown",
              { 0.84f, 0.0f, 0.48f, 0.004f, 2.5f, 0.35f, 0.25f, 0.50f,
                0.05f, 0.0f, 0.55f, 0.45f, 3000.0f, 0.0f, 0.22f, 0.0f } },
            { "Rock Solide",
              { 0.86f, 0.0f, 0.58f, 0.002f, 1.8f, 0.30f, 0.20f, 0.40f,
                0.18f, 0.0f, 0.45f, 0.55f, 4200.0f, 0.0f, 0.28f, 0.0f } },
            { "Jazz Fusion",
              { 0.84f, 0.0f, 0.65f, 0.003f, 2.0f, 0.28f, 0.20f, 0.35f,
                0.08f, 0.0f, 0.55f, 0.65f, 5000.0f, 0.0f, 0.25f, 0.0f } },
            { "Pop Ronde",
              { 0.83f, 0.0f, 0.50f, 0.005f, 2.8f, 0.35f, 0.28f, 0.40f,
                0.00f, 0.0f, 0.50f, 0.45f, 3800.0f, 0.0f, 0.20f, 0.0f } },
            { "Funk Doigts",
              { 0.86f, 0.0f, 0.62f, 0.002f, 1.5f, 0.25f, 0.18f, 0.42f,
                0.12f, 0.0f, 0.48f, 0.65f, 5500.0f, 0.0f, 0.30f, 0.0f } },
            // --- Registres et styles ---
            { "R&B Velours",
              { 0.82f, 0.0f, 0.42f, 0.006f, 3.0f, 0.40f, 0.32f, 0.48f,
                0.03f, 0.0f, 0.58f, 0.42f, 2800.0f, 0.0f, 0.20f, 0.0f } },
            { "Indie Doux",
              { 0.80f, 0.0f, 0.45f, 0.005f, 2.5f, 0.38f, 0.30f, 0.44f,
                0.02f, 0.0f, 0.52f, 0.48f, 3200.0f, 0.0f, 0.22f, 0.0f } },
            { "Blues Profond",
              { 0.84f, 0.0f, 0.52f, 0.004f, 2.8f, 0.35f, 0.28f, 0.52f,
                0.08f, 0.0f, 0.55f, 0.50f, 3500.0f, 0.0f, 0.25f, 0.0f } },
            { "Gospel Punch",
              { 0.86f, 0.0f, 0.58f, 0.002f, 1.8f, 0.28f, 0.22f, 0.38f,
                0.14f, 0.0f, 0.50f, 0.60f, 4500.0f, 0.0f, 0.28f, 0.0f } },
            { "Country Road",
              { 0.83f, 0.0f, 0.55f, 0.003f, 2.0f, 0.32f, 0.25f, 0.42f,
                0.06f, 0.0f, 0.48f, 0.52f, 4000.0f, 0.0f, 0.24f, 0.0f } },
            { "Reggae Laid Back",
              { 0.82f, 0.0f, 0.40f, 0.008f, 3.5f, 0.42f, 0.35f, 0.55f,
                0.02f, 0.0f, 0.55f, 0.45f, 2500.0f, 0.0f, 0.18f, 0.0f } },
            { "Neo Soul",
              { 0.82f, 0.0f, 0.46f, 0.005f, 2.8f, 0.38f, 0.30f, 0.50f,
                0.04f, 0.0f, 0.56f, 0.48f, 3000.0f, 0.0f, 0.22f, 0.0f } },
            { "Alt Rock Grit",
              { 0.88f, 0.0f, 0.62f, 0.001f, 1.5f, 0.22f, 0.15f, 0.35f,
                0.22f, 0.0f, 0.42f, 0.62f, 5200.0f, 0.0f, 0.32f, 0.0f } },
            // --- Travaill\xC3\xA9s ---
            { "Fingered Round Warm",
              { 0.80f, 0.0f, 0.38f, 0.008f, 3.5f, 0.45f, 0.38f, 0.55f,
                0.00f, 0.0f, 0.58f, 0.40f, 2200.0f, 0.0f, 0.18f, 0.0f } },
            { "Disco Groove",
              { 0.86f, 0.0f, 0.60f, 0.002f, 1.5f, 0.25f, 0.18f, 0.38f,
                0.10f, 0.0f, 0.48f, 0.62f, 5000.0f, 0.0f, 0.30f, 0.0f } },
            { "Ballad Intime",
              { 0.78f, 0.0f, 0.40f, 0.010f, 4.0f, 0.48f, 0.45f, 0.52f,
                0.00f, 0.0f, 0.55f, 0.42f, 2500.0f, 0.0f, 0.18f, 0.0f } },
            { "Punk Drive",
              { 0.90f, 0.0f, 0.68f, 0.001f, 1.2f, 0.18f, 0.12f, 0.30f,
                0.28f, 0.0f, 0.40f, 0.68f, 6000.0f, 0.0f, 0.35f, 0.0f } },
            { "Latin Groove",
              { 0.84f, 0.0f, 0.55f, 0.003f, 2.0f, 0.30f, 0.22f, 0.42f,
                0.06f, 0.0f, 0.50f, 0.55f, 4200.0f, 0.0f, 0.25f, 0.0f } },
            { "Fingered Sub Heavy",
              { 0.86f, 0.0f, 0.35f, 0.006f, 3.2f, 0.40f, 0.35f, 0.50f,
                0.05f, 0.0f, 0.65f, 0.40f, 2000.0f, 0.0f, 0.18f, 0.0f } },
            { "Prog Technique",
              { 0.84f, 0.0f, 0.64f, 0.002f, 1.8f, 0.28f, 0.18f, 0.36f,
                0.10f, 0.0f, 0.45f, 0.62f, 5500.0f, 0.0f, 0.30f, 0.0f } },
            { "Metal Agressif",
              { 0.90f, 0.0f, 0.72f, 0.001f, 1.2f, 0.15f, 0.10f, 0.28f,
                0.32f, 0.0f, 0.38f, 0.72f, 6500.0f, 0.0f, 0.38f, 0.0f } },
            { "Mute Doux",
              { 0.80f, 0.0f, 0.32f, 0.003f, 1.0f, 0.12f, 0.10f, 0.60f,
                0.00f, 0.0f, 0.52f, 0.35f, 1800.0f, 0.0f, 0.15f, 0.0f } },
            { "Fingered Sustain Long",
              { 0.82f, 0.0f, 0.48f, 0.006f, 5.0f, 0.52f, 0.55f, 0.45f,
                0.02f, 0.0f, 0.55f, 0.48f, 3200.0f, 0.0f, 0.22f, 0.0f } },
            { "Comp\xC3\xA9tition Slick",
              { 0.88f, 0.0f, 0.66f, 0.002f, 1.5f, 0.25f, 0.15f, 0.35f,
                0.15f, 0.0f, 0.45f, 0.60f, 5800.0f, 0.0f, 0.32f, 0.0f } },
            { "Dub Profond",
              { 0.82f, 0.0f, 0.35f, 0.008f, 4.0f, 0.45f, 0.40f, 0.58f,
        ...
        // =====================================================================
        {
            // --- Neutres / fondamentaux ---
            { "Slap Classique",
              { 0.85f, 0.0f, 0.68f, 0.001f, 1.5f, 0.18f, 0.15f, 0.35f,
                0.12f, 0.0f, 0.48f, 0.62f, 5000.0f, 0.0f, 0.32f, 0.0f } },
            { "Funk Attack",
              { 0.88f, 0.0f, 0.75f, 0.001f, 1.2f, 0.12f, 0.12f, 0.30f,
                0.22f, 0.0f, 0.42f, 0.72f, 6500.0f, 0.0f, 0.38f, 0.0f } },
            { "Slap Groovy",
              { 0.84f, 0.0f, 0.65f, 0.002f, 1.8f, 0.20f, 0.18f, 0.38f,
                0.10f, 0.0f, 0.52f, 0.58f, 4500.0f, 0.0f, 0.30f, 0.0f } },
            { "Double Thumb",
              { 0.86f, 0.0f, 0.60f, 0.001f, 1.6f, 0.22f, 0.18f, 0.40f,
                0.08f, 0.0f, 0.55f, 0.55f, 4200.0f, 0.0f, 0.35f, 0.0f } },
            { "Slap Profond",
              { 0.85f, 0.0f, 0.58f, 0.002f, 2.2f, 0.25f, 0.22f, 0.45f,
                0.15f, 0.0f, 0.60f, 0.55f, 3500.0f, 0.0f, 0.28f, 0.0f } },
            // --- Registres et styles ---
            { "Pop Slap",
              { 0.84f, 0.0f, 0.62f, 0.001f, 1.8f, 0.22f, 0.18f, 0.36f,
                0.10f, 0.0f, 0.50f, 0.58f, 4800.0f, 0.0f, 0.30f, 0.0f } },
            { "Slap Marcus",
              { 0.88f, 0.0f, 0.78f, 0.001f, 1.0f, 0.10f, 0.10f, 0.28f,
                0.25f, 0.0f, 0.40f, 0.75f, 7000.0f, 0.0f, 0.42f, 0.0f } },
            { "Thumb Heavy",
              { 0.86f, 0.0f, 0.55f, 0.001f, 2.0f, 0.28f, 0.22f, 0.48f,
                0.18f, 0.0f, 0.58f, 0.52f, 3800.0f, 0.0f, 0.28f, 0.0f } },
            { "Slap Bright Pop",
              { 0.86f, 0.0f, 0.72f, 0.001f, 1.4f, 0.15f, 0.12f, 0.32f,
                0.14f, 0.0f, 0.44f, 0.65f, 6000.0f, 0.0f, 0.35f, 0.0f } },
            { "Slap R&B",
              { 0.84f, 0.0f, 0.60f, 0.002f, 2.0f, 0.25f, 0.20f, 0.42f,
                0.08f, 0.0f, 0.55f, 0.55f, 4500.0f, 0.0f, 0.28f, 0.0f } },
            { "Wooten Fury",
              { 0.90f, 0.0f, 0.82f, 0.001f, 0.8f, 0.08f, 0.08f, 0.25f,
                0.30f, 0.0f, 0.38f, 0.80f, 8000.0f, 0.0f, 0.45f, 0.0f } },
            { "Slap Lo-Fi",
              { 0.82f, 0.0f, 0.50f, 0.002f, 2.5f, 0.30f, 0.25f, 0.50f,
                0.20f, 0.0f, 0.55f, 0.50f, 3000.0f, 0.0f, 0.25f, 0.0f } },
            { "Slap Ghost Notes",
              { 0.80f, 0.0f, 0.64f, 0.001f, 0.8f, 0.08f, 0.06f, 0.32f,
                0.10f, 0.0f, 0.42f, 0.60f, 5500.0f, 0.0f, 0.32f, 0.0f } },
            // --- Travaill\xC3\xA9s ---
            { "Festival Punchy",
              { 0.90f, 0.0f, 0.76f, 0.001f, 1.0f, 0.10f, 0.08f, 0.28f,
                0.28f, 0.0f, 0.40f, 0.75f, 7500.0f, 0.0f, 0.40f, 0.0f } },
            { "Slap Vintage 70s",
              { 0.84f, 0.0f, 0.58f, 0.002f, 2.0f, 0.25f, 0.22f, 0.45f,
                0.12f, 0.0f, 0.52f, 0.55f, 4000.0f, 0.0f, 0.28f, 0.0f } },
            { "Slap Comp\xC3\xA9tition",
              { 0.88f, 0.0f, 0.74f, 0.001f, 1.2f, 0.12f, 0.10f, 0.30f,
                0.20f, 0.0f, 0.42f, 0.70f, 6500.0f, 0.0f, 0.38f, 0.0f } },
            { "Slap Jazz",
              { 0.82f, 0.0f, 0.62f, 0.002f, 2.0f, 0.22f, 0.20f, 0.40f,
                0.05f, 0.0f, 0.50f, 0.58f, 5000.0f, 0.0f, 0.30f, 0.0f } },
            { "Slap \xC3\x89""lectrique",
              { 0.86f, 0.0f, 0.70f, 0.001f, 1.5f, 0.18f, 0.15f, 0.35f,
                0.16f, 0.0f, 0.45f, 0.65f, 5500.0f, 0.0f, 0.35f, 0.0f } },
            { "Slap Sub Lourd",
              { 0.86f, 0.0f, 0.52f, 0.002f, 2.5f, 0.30f, 0.28f, 0.50f,
                0.18f, 0.0f, 0.65f, 0.50f, 3200.0f, 0.0f, 0.25f, 0.0f } },
            { "Slap Staccato",
              { 0.88f, 0.0f, 0.70f, 0.001f, 0.6f, 0.05f, 0.05f, 0.25f,
                0.15f, 0.0f, 0.40f, 0.68f, 7000.0f, 0.0f, 0.38f, 0.0f } },
            { "Slap Chorus",
              { 0.84f, 0.0f, 0.66f, 0.002f, 1.8f, 0.20f, 0.18f, 0.38f,
                0.12f, 0.0f, 0.48f, 0.60f, 5200.0f, 0.0f, 0.32f, 0.0f } },
            { "Slap Drive Sale",
              { 0.88f, 0.0f, 0.72f, 0.001f, 1.2f, 0.12f, 0.10f, 0.30f,
                0.35f, 0.0f, 0.42f, 0.72f, 6000.0f, 0.0f, 0.38f, 0.0f } },
            { "Slap Sustain Chaud",
              { 0.82f, 0.0f, 0.56f, 0.003f, 3.0f, 0.35f, 0.30f, 0.48f,
                0.08f, 0.0f, 0.55f, 0.52f, 3800.0f, 0.0f, 0.26f, 0.0f } },
            { "Slap Harmonique",
              { 0.80f, 0.0f, 0.80f, 0.001f, 2.0f, 0.15f, 0.18f, 0.28f,
        ...
        // =====================================================================
        {
            // --- Neutres / fondamentaux ---
            { "Sub Pur",
              { 0.90f, 0.0f, 0.18f, 0.002f, 5.0f, 0.45f, 0.35f, 0.0f,
                0.00f, 0.75f, 0.72f, 0.45f, 700.0f, 0.0f, 0.15f, 0.0f } },
            { "Trap Minimal",
              { 0.90f, 0.0f, 0.22f, 0.002f, 4.0f, 0.40f, 0.28f, 0.0f,
                0.00f, 0.90f, 0.70f, 0.50f, 650.0f, 0.0f, 0.15f, 0.0f } },
            { "Sub Long",
              { 0.88f, 0.0f, 0.18f, 0.003f, 8.0f, 0.55f, 0.45f, 0.0f,
                0.00f, 0.65f, 0.75f, 0.40f, 600.0f, 0.0f, 0.12f, 0.0f } },
            { "Drill Drop",
              { 0.92f, 0.0f, 0.20f, 0.001f, 3.0f, 0.30f, 0.20f, 0.0f,
                0.00f, 1.00f, 0.68f, 0.55f, 750.0f, 0.0f, 0.18f, 0.0f } },
            { "Club Sub",
              { 0.90f, 0.0f, 0.22f, 0.002f, 4.5f, 0.42f, 0.32f, 0.0f,
                0.00f, 0.85f, 0.70f, 0.50f, 800.0f, 0.0f, 0.15f, 0.0f } },
            // --- Registres et styles ---
            { "808 Lourd",
              { 0.92f, 0.0f, 0.16f, 0.002f, 6.0f, 0.50f, 0.40f, 0.0f,
                0.00f, 0.80f, 0.78f, 0.48f, 650.0f, 0.0f, 0.14f, 0.0f } },
            { "Trap Court",
              { 0.90f, 0.0f, 0.24f, 0.001f, 2.5f, 0.25f, 0.18f, 0.0f,
                0.00f, 0.95f, 0.65f, 0.52f, 720.0f, 0.0f, 0.16f, 0.0f } },
            { "Sub Gliss\xC3\xA9",
              { 0.88f, 0.0f, 0.20f, 0.002f, 5.0f, 0.45f, 0.35f, 0.0f,
                0.00f, 0.70f, 0.72f, 0.45f, 680.0f, 0.0f, 0.14f, 0.08f } },
            { "UK Garage Sub",
              { 0.88f, 0.0f, 0.22f, 0.003f, 3.5f, 0.35f, 0.28f, 0.0f,
                0.00f, 0.82f, 0.68f, 0.50f, 750.0f, 0.0f, 0.16f, 0.0f } },
            { "Lo-Fi 808",
              { 0.86f, 0.0f, 0.20f, 0.004f, 4.5f, 0.42f, 0.35f, 0.0f,
                0.03f, 0.72f, 0.70f, 0.48f, 620.0f, 0.0f, 0.14f, 0.0f } },
            { "Phonk Sub",
              { 0.92f, 0.0f, 0.25f, 0.001f, 3.5f, 0.32f, 0.22f, 0.0f,
                0.05f, 0.92f, 0.65f, 0.55f, 780.0f, 0.0f, 0.18f, 0.0f } },
            { "Ambient Sub",
              { 0.84f, 0.0f, 0.15f, 0.008f, 9.0f, 0.58f, 0.60f, 0.0f,
                0.00f, 0.55f, 0.78f, 0.38f, 550.0f, 0.0f, 0.10f, 0.0f } },
            { "Sub Staccato",
              { 0.90f, 0.0f, 0.22f, 0.001f, 1.5f, 0.15f, 0.10f, 0.0f,
                0.00f, 0.85f, 0.62f, 0.50f, 700.0f, 0.0f, 0.15f, 0.0f } },
            // --- Travaill\xC3\xA9s ---
            { "Reggaeton Sub",
              { 0.88f, 0.0f, 0.20f, 0.002f, 3.8f, 0.38f, 0.28f, 0.0f,
                0.00f, 0.88f, 0.72f, 0.50f, 700.0f, 0.0f, 0.16f, 0.0f } },
            { "Sub Vibrant",
              { 0.90f, 0.0f, 0.18f, 0.003f, 5.5f, 0.48f, 0.38f, 0.0f,
                0.00f, 0.78f, 0.75f, 0.45f, 660.0f, 0.0f, 0.14f, 0.0f } },
            { "Ultra Low",
              { 0.92f, 0.0f, 0.12f, 0.003f, 7.0f, 0.52f, 0.42f, 0.0f,
                0.00f, 0.60f, 0.82f, 0.35f, 500.0f, 0.0f, 0.10f, 0.0f } },
            { "Bounce 808",
              { 0.90f, 0.0f, 0.24f, 0.001f, 2.8f, 0.28f, 0.18f, 0.0f,
                0.02f, 0.92f, 0.66f, 0.52f, 740.0f, 0.0f, 0.16f, 0.0f } },
            { "Jersey Club",
              { 0.88f, 0.0f, 0.22f, 0.002f, 3.0f, 0.32f, 0.22f, 0.0f,
        ...
        // =====================================================================
        {
            // --- Neutres / fondamentaux ---
            { "Boom Standard",
              { 0.88f, 0.0f, 0.28f, 0.003f, 6.0f, 0.42f, 0.35f, 0.0f,
                0.15f, 0.62f, 0.75f, 0.55f, 1200.0f, 0.0f, 0.22f, 0.0f } },
            { "Trap Boom",
              { 0.90f, 0.0f, 0.35f, 0.002f, 5.0f, 0.40f, 0.28f, 0.0f,
                0.30f, 0.70f, 0.72f, 0.60f, 1100.0f, 0.0f, 0.25f, 0.0f } },
            { "Heavy Hip-Hop",
              { 0.92f, 0.0f, 0.25f, 0.004f, 7.0f, 0.50f, 0.50f, 0.0f,
                0.20f, 0.55f, 0.80f, 0.50f,  900.0f, 0.0f, 0.20f, 0.0f } },
            { "808 Satur\xC3\xA9",
              { 0.88f, 0.0f, 0.40f, 0.002f, 4.5f, 0.35f, 0.25f, 0.0f,
                0.45f, 0.75f, 0.68f, 0.65f, 1400.0f, 0.0f, 0.28f, 0.0f } },
            { "808 M\xC3\xA9""lodique",
              { 0.85f, 0.0f, 0.22f, 0.003f, 8.0f, 0.55f, 0.60f, 0.0f,
                0.10f, 0.50f, 0.80f, 0.45f,  800.0f, 0.0f, 0.18f, 0.0f } },
            // --- Registres et styles ---
            { "Boom Deep",
              { 0.90f, 0.0f, 0.22f, 0.004f, 7.5f, 0.52f, 0.45f, 0.0f,
                0.12f, 0.55f, 0.82f, 0.48f,  850.0f, 0.0f, 0.18f, 0.0f } },
            { "Boom Clap",
              { 0.92f, 0.0f, 0.32f, 0.001f, 3.5f, 0.28f, 0.20f, 0.0f,
                0.35f, 0.80f, 0.68f, 0.62f, 1300.0f, 0.0f, 0.28f, 0.0f } },
            { "Boom Smooth",
              { 0.86f, 0.0f, 0.25f, 0.005f, 6.5f, 0.48f, 0.42f, 0.0f,
                0.10f, 0.58f, 0.78f, 0.50f,  950.0f, 0.0f, 0.20f, 0.0f } },
            { "Boom Punch",
              { 0.92f, 0.0f, 0.35f, 0.001f, 4.0f, 0.32f, 0.22f, 0.0f,
                0.32f, 0.75f, 0.70f, 0.62f, 1200.0f, 0.0f, 0.26f, 0.0f } },
            { "Boom R&B",
              { 0.86f, 0.0f, 0.28f, 0.004f, 5.5f, 0.45f, 0.38f, 0.0f,
                0.15f, 0.60f, 0.76f, 0.52f, 1000.0f, 0.0f, 0.22f, 0.0f } },
            { "Boom Reggaeton",
              { 0.90f, 0.0f, 0.30f, 0.002f, 4.5f, 0.38f, 0.28f, 0.0f,
                0.25f, 0.72f, 0.72f, 0.58f, 1100.0f, 0.0f, 0.24f, 0.0f } },
            { "Boom Lo-Fi",
              { 0.84f, 0.0f, 0.25f, 0.005f, 5.0f, 0.42f, 0.35f, 0.0f,
                0.18f, 0.58f, 0.75f, 0.50f,  900.0f, 0.0f, 0.20f, 0.0f } },
            { "Boom Phonk",
              { 0.92f, 0.0f, 0.38f, 0.001f, 3.5f, 0.30f, 0.22f, 0.0f,
                0.40f, 0.85f, 0.65f, 0.65f, 1400.0f, 0.0f, 0.30f, 0.0f } },
            // --- Travaill\xC3\xA9s ---
            { "Boom Layered",
              { 0.88f, 0.0f, 0.30f, 0.003f, 6.0f, 0.45f, 0.38f, 0.0f,
                0.22f, 0.65f, 0.78f, 0.55f, 1100.0f, 0.0f, 0.24f, 0.0f } },
            { "Boom Dark",
              { 0.90f, 0.0f, 0.20f, 0.004f, 7.0f, 0.52f, 0.48f, 0.0f,
                0.18f, 0.52f, 0.82f, 0.45f,  800.0f, 0.0f, 0.18f, 0.0f } },
            { "Boom BassHead",
              { 0.94f, 0.0f, 0.42f, 0.001f, 5.0f, 0.38f, 0.30f, 0.0f,
                0.50f, 0.78f, 0.72f, 0.68f, 1500.0f, 0.0f, 0.32f, 0.0f } },
            { "Boom Sustain",
              { 0.86f, 0.0f, 0.24f, 0.004f, 9.0f, 0.58f, 0.55f, 0.0f,
                0.10f, 0.50f, 0.82f, 0.45f,  800.0f, 0.0f, 0.18f, 0.0f } },
            { "Boom ATL",
              { 0.90f, 0.0f, 0.32f, 0.002f, 5.0f, 0.40f, 0.30f, 0.0f,
                0.28f, 0.72f, 0.74f, 0.58f, 1150.0f, 0.0f, 0.25f, 0.0f } },
            { "Boom Glide",
              { 0.88f, 0.0f, 0.28f, 0.003f, 6.0f, 0.42f, 0.35f, 0.0f,
                0.15f, 0.62f, 0.75f, 0.55f, 1000.0f, 0.0f, 0.22f, 0.08f } },
            { "Boom Speaker Blow",
              { 0.94f, 0.0f, 0.45f, 0.001f, 4.0f, 0.30f, 0.22f, 0.0f,
                0.55f, 0.82f, 0.65f, 0.72f, 1600.0f, 0.0f, 0.35f, 0.0f } },
            { "Boom Festival",
              { 0.92f, 0.0f, 0.35f, 0.002f, 5.5f, 0.42f, 0.32f, 0.0f,
                0.30f, 0.70f, 0.75f, 0.60f, 1200.0f, 0.0f, 0.26f, 0.0f } },
            { "Boom Film Score",
              { 0.86f, 0.0f, 0.20f, 0.005f, 8.0f, 0.55f, 0.55f, 0.0f,
                0.08f, 0.48f, 0.82f, 0.42f,  750.0f, 0.0f, 0.16f, 0.0f } },
            { "Boom Vinyl Crunch",
              { 0.86f, 0.0f, 0.30f, 0.004f, 5.0f, 0.40f, 0.32f, 0.0f,
                0.22f, 0.60f, 0.74f, 0.55f, 1000.0f, 0.0f, 0.22f, 0.0f } },
            { "Boom Mono Funk",
              { 0.90f, 0.0f, 0.34f, 0.002f, 4.5f, 0.35f, 0.25f, 0.0f,
        ...
        // =====================================================================
        {
            // --- Neutres / fondamentaux ---
            { "Rage 808",
              { 0.88f, 0.0f, 0.40f, 0.001f, 3.0f, 0.22f, 0.18f, 0.0f,
                0.80f, 0.95f, 0.58f, 0.72f, 1800.0f, 0.0f, 0.35f, 0.0f } },
            { "Trap Gritty",
              { 0.85f, 0.0f, 0.38f, 0.001f, 3.5f, 0.28f, 0.22f, 0.0f,
                0.55f, 0.88f, 0.60f, 0.65f, 1600.0f, 0.0f, 0.30f, 0.0f } },
            { "Grunge Sub",
              { 0.84f, 0.0f, 0.30f, 0.002f, 2.5f, 0.25f, 0.20f, 0.0f,
                0.65f, 0.85f, 0.65f, 0.60f, 1200.0f, 0.0f, 0.28f, 0.0f } },
            { "808 Clipp\xC3\xA9",
              { 0.86f, 0.0f, 0.45f, 0.001f, 2.8f, 0.20f, 0.18f, 0.0f,
                0.90f, 0.92f, 0.55f, 0.78f, 2000.0f, 0.0f, 0.38f, 0.0f } },
            { "Acide Satur\xC3\xA9",
              { 0.85f, 0.0f, 0.50f, 0.001f, 2.0f, 0.20f, 0.15f, 0.0f,
                0.70f, 0.95f, 0.50f, 0.75f, 2200.0f, 0.0f, 0.40f, 0.0f } },
            // --- Registres et styles ---
            { "Distort Lourd",
              { 0.90f, 0.0f, 0.42f, 0.001f, 3.5f, 0.25f, 0.20f, 0.0f,
                0.85f, 0.90f, 0.55f, 0.75f, 1900.0f, 0.0f, 0.36f, 0.0f } },
            { "Trash 808",
              { 0.88f, 0.0f, 0.48f, 0.001f, 2.5f, 0.18f, 0.15f, 0.0f,
                0.92f, 0.95f, 0.50f, 0.82f, 2200.0f, 0.0f, 0.42f, 0.0f } },
            { "808 Buzz Saw",
              { 0.86f, 0.0f, 0.52f, 0.001f, 2.0f, 0.15f, 0.12f, 0.0f,
                0.88f, 0.92f, 0.48f, 0.80f, 2400.0f, 0.0f, 0.40f, 0.0f } },
            { "Distort Warm",
              { 0.84f, 0.0f, 0.35f, 0.002f, 4.0f, 0.32f, 0.28f, 0.0f,
                0.55f, 0.80f, 0.62f, 0.60f, 1400.0f, 0.0f, 0.28f, 0.0f } },
            { "808 Crunch",
              { 0.88f, 0.0f, 0.44f, 0.001f, 3.0f, 0.22f, 0.18f, 0.0f,
                0.75f, 0.88f, 0.56f, 0.70f, 1800.0f, 0.0f, 0.35f, 0.0f } },
            { "Industrial 808",
              { 0.86f, 0.0f, 0.50f, 0.001f, 2.2f, 0.18f, 0.15f, 0.0f,
                0.95f, 0.95f, 0.48f, 0.85f, 2500.0f, 0.0f, 0.45f, 0.0f } },
            { "808 Scream",
              { 0.90f, 0.0f, 0.55f, 0.001f, 1.8f, 0.12f, 0.10f, 0.0f,
                0.98f, 0.98f, 0.45f, 0.90f, 2800.0f, 0.0f, 0.48f, 0.0f } },
            { "Distort Short",
              { 0.88f, 0.0f, 0.42f, 0.001f, 1.5f, 0.10f, 0.08f, 0.0f,
                0.82f, 0.90f, 0.52f, 0.72f, 2000.0f, 0.0f, 0.38f, 0.0f } },
            // --- Travaill\xC3\xA9s ---
            { "Phonk Rage",
              { 0.92f, 0.0f, 0.46f, 0.001f, 2.8f, 0.20f, 0.16f, 0.0f,
                0.88f, 0.94f, 0.52f, 0.78f, 2000.0f, 0.0f, 0.38f, 0.0f } },
            { "Distort M\xC3\xA9""lodie",
              { 0.84f, 0.0f, 0.35f, 0.002f, 5.0f, 0.40f, 0.35f, 0.0f,
                0.50f, 0.70f, 0.65f, 0.58f, 1200.0f, 0.0f, 0.26f, 0.0f } },
            { "808 Fuzz",
              { 0.88f, 0.0f, 0.48f, 0.001f, 2.5f, 0.18f, 0.15f, 0.0f,
                0.90f, 0.92f, 0.50f, 0.80f, 2200.0f, 0.0f, 0.42f, 0.0f } },
            { "Distort Glide",
              { 0.86f, 0.0f, 0.40f, 0.001f, 3.5f, 0.25f, 0.20f, 0.0f,
                0.72f, 0.88f, 0.58f, 0.68f, 1700.0f, 0.0f, 0.32f, 0.06f } },
            { "808 RMS Max",
              { 0.94f, 0.0f, 0.50f, 0.001f, 2.0f, 0.15f, 0.12f, 0.0f,
                0.95f, 0.95f, 0.48f, 0.85f, 2500.0f, 0.0f, 0.45f, 0.0f } },
            { "Distort Ambient",
              { 0.80f, 0.0f, 0.28f, 0.005f, 6.0f, 0.45f, 0.50f, 0.0f,
                0.42f, 0.65f, 0.68f, 0.55f, 1000.0f, 0.0f, 0.22f, 0.0f } },
            { "808 Broken Speaker",
              { 0.88f, 0.0f, 0.52f, 0.001f, 2.2f, 0.15f, 0.12f, 0.0f,
                0.96f, 0.94f, 0.48f, 0.88f, 2600.0f, 0.0f, 0.45f, 0.0f } },
            { "Distort Bounce",
              { 0.90f, 0.0f, 0.42f, 0.001f, 3.0f, 0.22f, 0.18f, 0.0f,
                0.78f, 0.90f, 0.55f, 0.72f, 1800.0f, 0.0f, 0.36f, 0.0f } },
            { "808 Tape Sat",
              { 0.84f, 0.0f, 0.35f, 0.002f, 4.0f, 0.35f, 0.30f, 0.0f,
        ...
        // =====================================================================
        {
            ...
            { "Moog Funk",
              { 0.85f, 0.0f, 0.65f, 0.002f, 1.5f, 0.30f, 0.20f, 0.0f,
                0.28f, 0.0f, 0.32f, 0.60f, 2800.0f, 0.0f, 0.45f, 0.03f } },
            { "Lead Bass",
              { 0.84f, 0.0f, 0.72f, 0.002f, 2.0f, 0.35f, 0.22f, 0.0f,
                0.25f, 0.0f, 0.30f, 0.65f, 3500.0f, 0.0f, 0.50f, 0.05f } },
            { "R\xC3\xA9""tro 70s",
              { 0.80f, 0.0f, 0.48f, 0.004f, 3.0f, 0.48f, 0.35f, 0.0f,
                0.15f, 0.0f, 0.42f, 0.45f, 1600.0f, 0.0f, 0.35f, 0.04f } },
            { "Moog Deep",
              { 0.82f, 0.0f, 0.40f, 0.005f, 3.5f, 0.50f, 0.35f, 0.0f,
                0.12f, 0.0f, 0.45f, 0.42f, 1200.0f, 0.0f, 0.38f, 0.05f } },
            // --- Registres et styles ---
            { "Moog Disco",
              { 0.86f, 0.0f, 0.68f, 0.002f, 1.5f, 0.28f, 0.18f, 0.0f,
                0.30f, 0.0f, 0.30f, 0.62f, 3200.0f, 0.0f, 0.48f, 0.03f } },
            { "Moog Sub Drone",
              { 0.80f, 0.0f, 0.32f, 0.008f, 5.0f, 0.55f, 0.50f, 0.0f,
            ...
            { "Moog Pad",
              { 0.78f, 0.0f, 0.38f, 0.015f, 5.0f, 0.55f, 0.60f, 0.0f,
                0.08f, 0.0f, 0.48f, 0.40f, 1200.0f, 0.0f, 0.32f, 0.0f } },
            { "Moog Stab",
              { 0.88f, 0.0f, 0.62f, 0.001f, 0.8f, 0.10f, 0.08f, 0.0f,
                0.22f, 0.0f, 0.30f, 0.58f, 3000.0f, 0.0f, 0.42f, 0.0f } },
            { "Moog Wah",
              { 0.84f, 0.0f, 0.58f, 0.003f, 2.0f, 0.35f, 0.25f, 0.0f,
                0.20f, 0.0f, 0.35f, 0.55f, 2400.0f, 0.0f, 0.62f, 0.04f } },
            { "Moog Solo Scream",
              { 0.86f, 0.0f, 0.78f, 0.001f, 1.8f, 0.28f, 0.20f, 0.0f,
                0.35f, 0.0f, 0.25f, 0.72f, 4500.0f, 0.0f, 0.58f, 0.03f } },
            { "Moog 80s Pop",
              { 0.83f, 0.0f, 0.55f, 0.003f, 2.2f, 0.38f, 0.28f, 0.0f,
                0.18f, 0.0f, 0.38f, 0.52f, 2200.0f, 0.0f, 0.42f, 0.04f } },
            // --- Travaill\xC3\xA9s ---
            { "Moog Prog",
              { 0.84f, 0.0f, 0.62f, 0.002f, 2.5f, 0.35f, 0.25f, 0.0f,
                0.22f, 0.0f, 0.35f, 0.58f, 2800.0f, 0.0f, 0.48f, 0.05f } },
            { "Moog Dark Ambient",
              { 0.78f, 0.0f, 0.30f, 0.012f, 6.0f, 0.55f, 0.60f, 0.0f,
                0.06f, 0.0f, 0.50f, 0.35f,  900.0f, 0.0f, 0.28f, 0.0f } },
            { "Moog Octave Split",
              { 0.84f, -12.0f, 0.55f, 0.003f, 2.0f, 0.35f, 0.25f, 0.0f,
                0.20f, 0.0f, 0.40f, 0.55f, 2200.0f, 0.0f, 0.42f, 0.0f } },
            { "Moog Reggae",
              { 0.82f, 0.0f, 0.42f, 0.006f, 3.5f, 0.45f, 0.38f, 0.0f,
                0.12f, 0.0f, 0.50f, 0.45f, 1500.0f, 0.0f, 0.35f, 0.04f } },
            { "Moog Acid Trip",
              { 0.85f, 0.0f, 0.70f, 0.001f, 1.2f, 0.20f, 0.12f, 0.0f,
                0.32f, 0.0f, 0.28f, 0.68f, 3800.0f, 0.0f, 0.60f, 0.03f } },
            { "Moog Filter Sweep",
              { 0.82f, 0.0f, 0.50f, 0.004f, 3.0f, 0.42f, 0.32f, 0.0f,
                0.15f, 0.0f, 0.42f, 0.48f, 1800.0f, 0.0f, 0.55f, 0.04f } },
            { "Moog Percussif",
              { 0.88f, 0.0f, 0.60f, 0.001f, 1.0f, 0.08f, 0.06f, 0.0f,
                0.25f, 0.0f, 0.30f, 0.60f, 3500.0f, 0.0f, 0.45f, 0.0f } },
            { "Moog Glide Legato",
              { 0.84f, 0.0f, 0.52f, 0.003f, 2.5f, 0.40f, 0.28f, 0.0f,
                0.18f, 0.0f, 0.38f, 0.50f, 2000.0f, 0.0f, 0.42f, 0.12f } },
            { "Moog EQ Boost",
              { 0.84f, 0.0f, 0.68f, 0.002f, 2.0f, 0.32f, 0.22f, 0.0f,
        ...
        // =====================================================================
        {
            // --- Neutres / fondamentaux ---
            { "Reese DnB",
              { 0.80f, 0.0f, 0.42f, 0.005f, 4.0f, 0.38f, 0.50f, 0.0f,
                0.12f, 0.0f, 0.52f, 0.62f, 1200.0f, 0.0f, 0.28f, 0.0f } },
            { "Reese Sombre",
              { 0.82f, 0.0f, 0.32f, 0.006f, 5.0f, 0.48f, 0.60f, 0.0f,
            ...
            { "Reese Large",
              { 0.80f, 0.0f, 0.38f, 0.006f, 4.5f, 0.45f, 0.55f, 0.0f,
                0.10f, 0.0f, 0.58f, 0.65f, 1000.0f, 0.0f, 0.28f, 0.0f } },
            { "Reese Ambient",
              { 0.78f, 0.0f, 0.32f, 0.010f, 6.0f, 0.52f, 0.70f, 0.0f,
                0.08f, 0.0f, 0.60f, 0.55f,  800.0f, 0.0f, 0.22f, 0.0f } },
            // --- Registres et styles ---
            { "Reese Jungle",
              { 0.82f, 0.0f, 0.45f, 0.004f, 3.5f, 0.35f, 0.42f, 0.0f,
                0.15f, 0.0f, 0.50f, 0.65f, 1300.0f, 0.0f, 0.30f, 0.0f } },
            { "Reese Dubstep",
              { 0.84f, 0.0f, 0.52f, 0.003f, 3.0f, 0.30f, 0.38f, 0.0f,
                0.25f, 0.0f, 0.45f, 0.70f, 1500.0f, 0.0f, 0.35f, 0.0f } },
            { "Reese Liquid",
              { 0.78f, 0.0f, 0.35f, 0.008f, 5.5f, 0.50f, 0.62f, 0.0f,
                0.06f, 0.0f, 0.58f, 0.55f,  850.0f, 0.0f, 0.22f, 0.0f } },
            { "Reese Minimal",
              { 0.80f, 0.0f, 0.38f, 0.006f, 4.0f, 0.42f, 0.50f, 0.0f,
            ...
            { "Reese Sub Deep",
              { 0.82f, 0.0f, 0.28f, 0.008f, 5.5f, 0.52f, 0.60f, 0.0f,
                0.05f, 0.0f, 0.62f, 0.50f,  750.0f, 0.0f, 0.20f, 0.0f } },
            { "Reese Techno",
              { 0.82f, 0.0f, 0.44f, 0.004f, 3.5f, 0.35f, 0.42f, 0.0f,
            ...
            // --- Travaill\xC3\xA9s ---
            { "Reese Slow Evolve",
              { 0.78f, 0.0f, 0.30f, 0.012f, 7.0f, 0.55f, 0.70f, 0.0f,
            ...
            { "Reese Pad Lush",
              { 0.76f, 0.0f, 0.28f, 0.015f, 8.0f, 0.58f, 0.80f, 0.0f,
                0.04f, 0.0f, 0.62f, 0.48f,  700.0f, 0.0f, 0.18f, 0.0f } },
            { "Reese Roller",
              { 0.82f, 0.0f, 0.42f, 0.005f, 4.0f, 0.38f, 0.48f, 0.0f,
                0.14f, 0.0f, 0.52f, 0.62f, 1200.0f, 0.0f, 0.28f, 0.0f } },
            { "Reese Dark Matter",
              { 0.84f, 0.0f, 0.48f, 0.004f, 3.5f, 0.32f, 0.40f, 0.0f,
                0.20f, 0.0f, 0.48f, 0.68f, 1400.0f, 0.0f, 0.32f, 0.0f } },
            { "Reese Cinematic",
              { 0.78f, 0.0f, 0.32f, 0.010f, 6.5f, 0.52f, 0.65f, 0.0f,
                0.08f, 0.0f, 0.58f, 0.55f,  850.0f, 0.0f, 0.22f, 0.0f } },
            { "Reese Glide Smooth",
              { 0.80f, 0.0f, 0.40f, 0.006f, 4.5f, 0.42f, 0.52f, 0.0f,
                0.12f, 0.0f, 0.55f, 0.60f, 1100.0f, 0.0f, 0.28f, 0.08f } },
            { "Reese Laser",
              { 0.84f, 0.0f, 0.58f, 0.002f, 2.5f, 0.25f, 0.30f, 0.0f,
                0.25f, 0.0f, 0.40f, 0.72f, 2000.0f, 0.0f, 0.38f, 0.0f } },
            { "Reese Sub Growl",
              { 0.82f, 0.0f, 0.35f, 0.005f, 4.0f, 0.40f, 0.48f, 0.0f,
        ...
        // =====================================================================
        {
            // --- Neutres / fondamentaux ---
            { "Acid 303",
              { 0.84f, 0.0f, 0.62f, 0.001f, 1.5f, 0.22f, 0.12f, 0.0f,
                0.18f, 0.0f, 0.28f, 0.60f, 2500.0f, 0.0f, 0.55f, 0.03f } },
            { "Acid Rapide",
              { 0.86f, 0.0f, 0.70f, 0.001f, 0.8f, 0.15f, 0.08f, 0.0f,
                0.22f, 0.0f, 0.25f, 0.70f, 3500.0f, 0.0f, 0.62f, 0.02f } },
            { "Acid Hardcore",
              { 0.88f, 0.0f, 0.78f, 0.001f, 1.2f, 0.15f, 0.10f, 0.0f,
                0.38f, 0.0f, 0.22f, 0.80f, 4500.0f, 0.0f, 0.68f, 0.02f } },
            { "Acid M\xC3\xA9""lodique",
              { 0.82f, 0.0f, 0.55f, 0.002f, 2.5f, 0.35f, 0.20f, 0.0f,
                0.12f, 0.0f, 0.35f, 0.52f, 2000.0f, 0.0f, 0.50f, 0.04f } },
            { "Techno Acid",
              { 0.85f, 0.0f, 0.65f, 0.001f, 1.0f, 0.18f, 0.10f, 0.0f,
                0.25f, 0.0f, 0.25f, 0.65f, 3200.0f, 0.0f, 0.58f, 0.02f } },
            // --- Registres et styles ---
            { "Acid Deep",
              { 0.82f, 0.0f, 0.50f, 0.002f, 2.0f, 0.30f, 0.18f, 0.0f,
            ...
            { "Acid Groove",
              { 0.84f, 0.0f, 0.60f, 0.001f, 1.5f, 0.22f, 0.15f, 0.0f,
                0.20f, 0.0f, 0.28f, 0.62f, 2800.0f, 0.0f, 0.55f, 0.03f } },
            { "Acid House",
              { 0.84f, 0.0f, 0.58f, 0.002f, 1.8f, 0.25f, 0.15f, 0.0f,
                0.18f, 0.0f, 0.30f, 0.58f, 2600.0f, 0.0f, 0.52f, 0.03f } },
            { "Acid Dark",
              { 0.82f, 0.0f, 0.48f, 0.002f, 2.2f, 0.28f, 0.20f, 0.0f,
                0.15f, 0.0f, 0.35f, 0.55f, 1800.0f, 0.0f, 0.50f, 0.04f } },
            { "Acid Rave",
              { 0.88f, 0.0f, 0.75f, 0.001f, 0.8f, 0.12f, 0.06f, 0.0f,
                0.30f, 0.0f, 0.22f, 0.75f, 4200.0f, 0.0f, 0.65f, 0.02f } },
            { "Acid Warm",
              { 0.82f, 0.0f, 0.45f, 0.003f, 2.5f, 0.38f, 0.25f, 0.0f,
                0.10f, 0.0f, 0.35f, 0.48f, 1800.0f, 0.0f, 0.45f, 0.04f } },
            { "Acid Staccato",
              { 0.86f, 0.0f, 0.68f, 0.001f, 0.5f, 0.08f, 0.05f, 0.0f,
                0.22f, 0.0f, 0.25f, 0.65f, 3500.0f, 0.0f, 0.60f, 0.0f } },
            // --- Travaill\xC3\xA9s ---
            { "Acid Screech",
              { 0.88f, 0.0f, 0.82f, 0.001f, 1.0f, 0.10f, 0.06f, 0.0f,
                0.35f, 0.0f, 0.20f, 0.85f, 5000.0f, 0.0f, 0.72f, 0.02f } },
            { "Acid Glide Lent",
              { 0.82f, 0.0f, 0.55f, 0.002f, 2.5f, 0.35f, 0.22f, 0.0f,
